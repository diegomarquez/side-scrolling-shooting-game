		...
		doSplash: function() {
          ...
          gb.debug = true;
      		gb.colliderDebug = true;
     	 		gb.rendererDebug = true;
      		gb.gameObjectDebug = true;
          ...
          var obstacle = gb.create('obstacle-4', 'First', [{viewport: 'Main', layer: 'Front'}], {
          	x: gb.canvas.width/2,
          	y: gb.canvas.height/2 
          });

          obstacle.findComponents().firstWithType("ObstacleCollider4").pointsCopy[0].x -= 10;
          obstacle.findComponents().firstWithType("ObstacleCollider4").pointsCopy[0].y -= 5;
          
          obstacle.findComponents().firstWithType("ObstacleCollider4").pointsCopy[1].x += 50;
          obstacle.findComponents().firstWithType("ObstacleCollider4").pointsCopy[1].y += 5;
          
          obstacle.findComponents().firstWithType("ObstacleCollider4").pointsCopy[2].x += 10;
          obstacle.findComponents().firstWithType("ObstacleCollider4").pointsCopy[2].y -= 5; 
          
          obstacle.findComponents().firstWithType("ObstacleCollider4").pointsCopy[3].x += 10 
          obstacle.findComponents().firstWithType("ObstacleCollider4").pointsCopy[3].y += 10;
