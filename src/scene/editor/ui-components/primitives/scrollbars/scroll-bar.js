    ...
    create: function(optionsGetter) {
      ...
      var scrollBarComponentExtension = {
        refresh: function() {
          ...
          initScrollBar(this.html, refreshOptions);
        },
        ...
        sliderOption: function(name) {
          return $(this.html).slider('option', name);
        },

        slider: function() {
          return $(this.html).slider.apply($(scrollbar), arguments);
        },

        destroy: function() {
          $(this.html).slider('destroy');
        }
      }

      return componentFactory.getController(scrollBarComponentExtension, scrollbar);
    }
  });
